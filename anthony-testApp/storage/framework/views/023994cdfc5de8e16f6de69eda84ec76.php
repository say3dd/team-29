...
<head>
    ...
    <title>Product</title>
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/style_sheet_product_webpage_template.css')); ?>">
...
<div class="main">
        ...
        <div class="background_shape1">
            ...
            <div class="slide">
                <div class="mySlides">
                    <img class="slide_image" src="<?php echo e(asset('assets/images_product/laptop4.jpg')); ?>" style=" " alt="">
                </div>
                <div class="mySlides">
                    <img class="slide_image" src="<?php echo e(asset('assets/images_product/laptop2.jpg')); ?>" alt="">
                </div>
                <div class="mySlides">
                    <img class="slide_image" src="<?php echo e(asset('assets/images_product/laptop3.jpg')); ?>" alt="">
                </div>
                <div class="mySlides">
                    <img class="slide_image" src="<?php echo e(asset('assets/images_product/laptop1.jpg')); ?>" alt="">
                </div>
                <div class="mySlides">
                    <img class="slide_image" src="<?php echo e(asset('assets/images_product/laptop5.jpg')); ?>" alt="">
                </div>
        ...
        <button class="button_cart">
            <img src="<?php echo e(asset('assets/images_product/icon_basket.png')); ?>" alt="" width="20" height="25">
            Add to Basket
        </button>
        <button class="button_wish">
            <img src="<?php echo e(asset('assets/images_product/love1.png')); ?>" alt="" width="25" height="23">
            Add to Wish List
        </button>
        </div>
    ...
    <div class = "container_section2">
        <div class="features_images">
            <img  src="<?php echo e(asset('assets/images_product/laptop_specification1.jpg')); ?>">
            <img  src="<?php echo e(asset('assets/images_product/laptop_specification2.jpg')); ?>">
            <img  src="<?php echo e(asset('assets/images_product/laptop_specification3.jpg')); ?>">
        </div>
        ...
        <div class="container_section3">
            ...
            <img class="unique_feature4_5_6_7_8_image" src="<?php echo e(asset('assets/images_product/laptop_specification5.jpg')); ?>">
        </div>
    
    
        <div class="container_section4">
            <img class="unique_feature9_image" src="<?php echo e(asset('assets/images_product/laptop_specification4.jpg')); ?>">
        ...
        <div class="container_section5">
            ...
            <div class="laptop1">
                <img class="related_product_image" src="<?php echo e(asset('assets/laptop_images/MSI Titan GT77 HX 13V/msi_Titan_GT77_HX_13V.jpg')); ?> ">
            ...
            <div class="laptop1">
                <img class="related_product_image" src="<?php echo e(asset('assets/laptop_images/Alienware M16/alienware_m16.jpg')); ?>">
            ...
            <div class="laptop1">
                <img class="related_product_image" src="<?php echo e(asset('assets/laptop_images/Asus ROG Strix G16 G614/asus_ROG_Strix_G16_G614.jpg')); ?>">
            ...
            <div class="laptop1">
                <img class="related_product_image" src="<?php echo e(asset('assets/laptop_images/Alienware M18/alienware-m18.jpg ')); ?>">
...
<?php /**PATH C:\Users\aliba\Documents\Git\team-29\anthony-testApp\resources\views/Product_files/product.blade.php ENDPATH**/ ?>