        ...
        <div class="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
            <div class="xl:w-3/5 flex flex-col sm:flex-row xl:flex-col justify-center items-center bg-gray-100 dark:bg-gray-800 py-7 sm:py-0 xl:py-10 px-10">
                ...
                <div class="flex flex-col justify-start items-start w-full space-y-4">
                    <p class="text-xl md:text-2xl leading-normal text-gray-800 dark:text-gray-50"><?php echo e($item->product_name); ?></p>
                    <p class="text-base font-semibold leading-none text-gray-600 dark:text-white">£<?php echo e($item->product_price); ?></p>
                </div>
            ...
            <div class="p-8 bg-gray-100 dark:bg-gray-800 flex flex-col lg:w-full xl:w-3/5">
                ...
                <div class="mt-2 flex-col">
                    <div class="relative ">
                        ...
                        <div id="dropdown" class=" hidden  z-10 w-full  bg-gray-50 justify-start flex-col text-gray-600">
                ...
                <form action='<?php echo e(route('checkout.placeOrder')); ?>' method="POST">
                    ...
                    <button class="mt-8 border border-transparent hover:border-gray-300 dark:bg-white dark:hover:bg-gray-900 dark:text-gray-900 dark:hover:text-white dark:border-transparent bg-gray-900 hover:bg-white text-white hover:text-gray-900 flex justify-center items-center py-4 rounded w-full">
                        <div>
                            <p class="text-base leading-4">Pay £<?php echo e($total); ?></p>
                        </div>
                    </button>
                </form>
            </div>
...
<?php /**PATH C:\Users\aliba\Documents\Git\team-29\anthony-testApp\resources\views/checkout/summary.blade.php ENDPATH**/ ?>